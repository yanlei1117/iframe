 ...
 */
public class DataDeleteService extends DefaultDataAccessService<Integer> {
    ...
    public boolean matchOperationDefine(OperationDefine operationDefine) {
        return operationDefine.getOperationName().equals(ServiceConstant.RESOURCE_OPERATOR_TYPE_DELETE);
    }
    ...
    public   Integer deal(DataResourceDefine dataResourceDefine, OperationDefine operationDefine,   Map jsonMap) throws Exception{
        ...
        int effectRecords =   myBatisMapper.deleteByExample(myBatisExample);
